...
import 'package:food_order_app/modules/home/vm/products_viev_model/products_controller.dart';
...
class _SlideableCartCardState extends State<SlideableCartCard>
  ...
  void didChangeDependencies() {
    void productInit() {
      product = context.read<ProductsController>().state.list.firstWhere(
            (element) => element.id == widget.cartItem.productId,
          );
    }

    final ProductsController productsController =
        context.read<ProductsController>();
    if (productsController.state.status != ProductsStateLoad.loaded) {
      productsController.fetchAndSetProducts().then((_) => productInit);
    } else {
      productInit();
    }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          product.productType.getProductUnit(
